  ...
  return Center(
    child: GestureDetector(
      ...
      child: Text(
        "Forgot password?",
        style: TextStyle(
            color: AutoBeresColors.greytransTextColor,
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
          color: buttonType == "login"
              ? AutoBeresColors.primaryColor
              : AppColors.primaryBackground,
          borderRadius: BorderRadius.circular(15.w),
          border: Border.all(
              //checka for registration button border color
              color: buttonType == "login"
                  ? Colors.transparent
      ...
      child: Center(
        ...
        style: TextStyle(
            ...
            color:
                buttonType == "login" ? Colors.black : AppColors.primaryText),
      )),
    ),
  );
}
